...
# ssm445基于SSM的学生宿舍管理系统+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=43)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本学生宿舍管理系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让考试信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，学生宿舍管理系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，学生宿舍管理系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
...
图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图，管理员在后台主要管理学生管理,来访人员管理等。
...
![C:\Users\Administrator\Desktop\img\susheguanli\班主任.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\班主任.jpg")
图4.1 班主任实体属性图

（2）下图是学生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\学生.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\学生.jpg")
图4.2 学生实体属性图

（3）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\公告信息.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\公告信息.jpg")
图4.3 公告信息实体属性图

（4）下图是宿舍实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\宿舍.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\宿舍.jpg")
图4.4 宿舍实体属性图

（5）下图是宿管实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\宿管.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\宿管.jpg")
图4.5 宿管实体属性图

（6）下图是快递实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\快递.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\快递.jpg")
图4.6 快递实体属性图

（7）下图是来访人员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\来访人员.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\来访人员.jpg")
图4.7 来访人员实体属性图

（8）下图是卫生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\susheguanli\卫生.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\susheguanli\卫生.jpg")
图4.8 卫生实体属性图
...
|6|laifang\_photo|String|健康码|是|
|7|shifou\_types|Integer|是否同意|是|
|8|laifang\_content|String|来访事由|是|
...
|4|suguan\_email|String|电子邮箱|是|
|5|loudong\_types|Integer|楼栋|是|
|6|insert\_time|Date|添加时间|是|
|7|create\_time|Date|创建时间|是|
表4.7宿舍表
...
## 5.1 管理员功能介绍
### 5.1.1 学生管理列表
如图5.1显示的就是学生管理列表页面，此页面提供给管理员的功能有：查看学生管理、新增学生管理、修改学生管理、删除学生管理等。
